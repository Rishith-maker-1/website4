...
function submit() {
    ...
    for (var x = 0; x<length_of_name_of_students_array; x++) {
...
function sort() {
    ...
    var length_of_name_of_students_array = name_of_the_student_array.length;
    console.log(length_of_name_of_students_array);
    for (var z = 0;z<length_of_name_of_students_array;z++){
        display_student_array_sorting.push("<h4>NAME - "+name_of_the_student_array[z]+"</h4>");
